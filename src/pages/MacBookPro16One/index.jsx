            ...
            <div className="flex flex-col items-center justify-start w-full">
                ...
                <div className="flex flex-row justify-end w-full mx-auto max-w-[1253px]">
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex flex-col items-center justify-start mt-[74px]">
                      ...
                      <Button
                        size="xs"
                        className="w-[49px] mt-[23px] bg-[url(/public/images/img_mask_group_49x49.png)] bg-cover bg-no-repeat"
                      >
                        <Img src="images/img_mask_group.svg" />
                      </Button>
                    </div>
              ...
              <div className="flex flex-row justify-center w-full mt-[50px]">
                <div className="flex flex-col items-center justify-start w-full">
                  ...
                  <MacBookPro16OneRowFortynine className="flex flex-row justify-start w-full mt-[-48px] pl-[589px] pr-14 max-w-[2925px]" />
                </div>
              </div>
              <Img
                src="images/img_rectangle_4444.png"
                alt="image_thirtysix"
